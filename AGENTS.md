...
I have zero coding background. I think in systems, decisions, and frameworks. I have designed, directed, and shipped live production software to Azure using Codex as my implementation layer. That is the model we use.

---

## How We Work

**I direct. Codex writes.**

- I define the problem, the constraints, and the outcome. Codex writes all code.
...
**Stack:** TypeScript 5.3, Node.js 20, Express 4.18, Anthropic SDK (Codex-sonnet-4-6), Docker, GitHub Actions, Azure Container Instances  
...
**Architecture:** Express → Orchestrator → [gc-agent | tom-agent | adr-agent] → Codex API; kb-loader reads VAF KB from GitHub; action-engine commits artefacts back to the repo
...
### Learn With Codex
**Repo:** github.com/ZenCloudAU/learn-with-Codex (this repo)  
